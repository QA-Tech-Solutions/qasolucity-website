...
requirements:
  - "Strong hands-on QA background, manual and automation"
  - "Comfortable teaching and explaining concepts clearly to complete beginners"
  - "Patient with people who are still building fundamentals, without dumbing down the material"
  - "Available for a few scheduled sessions per week (hybrid: mostly online, occasional in-person Lagos sessions)"
  - "A reliable laptop and stable internet connection for live online sessions"
niceToHave:
  - "An ISTQB certification of your own"
  - "Prior teaching, mentoring, or bootcamp instruction experience"
hiringProcess:
  - "Application review"
  - "Intro call"
  - "Trial teaching session (paid)"
  - "Offer"
---
...
- Running one or two live class sessions (ISTQB prep or Career Launchpad)
- Reviewing student exercises and mock exam attempts
- Answering questions in office hours or async between sessions
- Occasionally refining a lesson or exercise that isn't landing the way it should
