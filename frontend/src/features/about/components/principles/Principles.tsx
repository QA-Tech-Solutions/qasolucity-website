  ...
  return (
    <Section className="relative overflow-hidden bg-gradient-to-b from-white dark:from-slate-900 via-white dark:via-slate-900 to-slate-50/40 dark:to-slate-900/40 py-32">
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none">
        ...
        {/* Radial fade */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_40%,rgba(255,255,255,0.2)_100%)] dark:bg-[radial-gradient(circle_at_center,transparent_40%,rgba(2,6,23,0.3)_100%)]" />
      </div>
