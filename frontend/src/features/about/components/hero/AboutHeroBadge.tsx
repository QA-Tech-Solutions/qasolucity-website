...
export default function AboutHeroBadge() {
  return (
    <Badge className="group inline-flex items-center gap-3 rounded-full border-0 bg-white/80 dark:bg-slate-900/80 px-5 py-2.5 shadow-sm shadow-indigo-100/50 backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:shadow-indigo-200/60">
