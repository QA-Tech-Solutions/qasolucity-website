          ...
          <div className="mx-auto flex max-w-3xl flex-col gap-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5 shadow-2xl shadow-slate-900/10 sm:flex-row sm:items-center sm:gap-6">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm leading-6 text-slate-600 dark:text-slate-400">
                This website uses cookies to optimize your experience and to provide us insight into
                how visitors interact with the site. All information shared with us through cookies is
                secure and handled in accordance with our data privacy obligations. See our{" "}
            ...
            <div className="flex shrink-0 items-center gap-3 sm:ml-auto">
              ...
              <button
                ...
                className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl text-slate-400 dark:text-slate-500 transition-colors duration-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-600 dark:hover:text-slate-300"
              >
