        ...
        <Container>
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-[minmax(0,1fr)_320px] lg:items-start">
            ...
            >
              ...
              <h2 className="mt-6 text-xl font-semibold text-slate-900 dark:text-slate-100">Why this works</h2>
              <p className="mt-3 text-sm leading-7 text-slate-600 dark:text-slate-400">{solution.summary}</p>
                  ...
                  >
                    ...
                    >
                      <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-indigo-50 dark:bg-indigo-950/40 transition-colors duration-300 group-hover:bg-indigo-100 dark:group-hover:bg-indigo-900/50">
                        <ServiceIcon className="h-5 w-5 text-indigo-600 dark:text-indigo-400" />
                      </div>
