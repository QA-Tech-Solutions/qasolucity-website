  ...
  return (
    <motion.article
      ...
      className={`
        ...
        ${
          open
            ? "border-indigo-200 dark:border-indigo-800/60 bg-white dark:bg-slate-900 shadow-xl shadow-indigo-100/30 dark:shadow-black/30"
            : "border-slate-200/80 dark:border-slate-800/80 bg-white/80 dark:bg-slate-900/80 hover:border-indigo-200 dark:hover:border-indigo-700 hover:shadow-lg hover:shadow-indigo-100/10 dark:hover:shadow-black/20"
        }
      `}
    >
      <button
      ...
      >
            ...
            className={`
              ...
              ${
                open
                  ...
                  : "text-slate-300 dark:text-slate-400 group-hover:text-indigo-400"
              }
            `}
          >
        ...
        <div
          className={`
            ...
            ${
              open
                ? "bg-gradient-to-br from-indigo-600 to-violet-600 text-white shadow-lg shadow-indigo-500/20 dark:shadow-indigo-950/40"
