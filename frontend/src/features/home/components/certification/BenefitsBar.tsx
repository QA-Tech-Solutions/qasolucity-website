...
export default function BenefitsBar() {
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-[34px] border border-slate-200/80 bg-gradient-to-br from-white via-white to-indigo-50/30 px-12 py-10 shadow-xl shadow-slate-200/40"
    >
      {/* Decorative Glows */}
      <div className="absolute -right-20 -top-20 h-72 w-72 rounded-full bg-indigo-100/20 blur-3xl" />
