            ...
            >
              <div className="grid items-center gap-8 sm:gap-12 lg:gap-16 lg:grid-cols-2">
                ...
                <div className="relative mx-auto flex justify-center">
                  {/* Glows */}
                  <div className="absolute -left-12 top-10 h-48 w-48 rounded-full bg-indigo-100/60 blur-3xl" />
                  <div className="absolute -right-12 bottom-10 h-56 w-56 rounded-full bg-violet-100/60 blur-3xl" />

                  {/* Decorative elements */}
                  <div className="absolute -left-8 -top-8 h-32 w-32 rounded-tl-[80px] border-l-[14px] border-t-[14px] border-indigo-100/50" />
                  <div className="absolute -right-8 -bottom-8 h-32 w-32 rounded-br-[80px] border-b-[14px] border-r-[14px] border-indigo-100/50" />
                ...
                <div className="relative max-w-lg">
                  {/* Quote icon */}
                  <Quote
                    className="absolute -right-4 -top-8 h-24 w-24 text-indigo-100/60 rotate-6"
                    strokeWidth={0.8}
                  />
