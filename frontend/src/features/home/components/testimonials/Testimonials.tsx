...
export default function Testimonials() {
  return (
    <Section className="relative overflow-hidden bg-[linear-gradient(135deg,_#fcfbf8_0%,_#f8f7ff_48%,_#fdf2f8_100%)] dark:bg-[linear-gradient(135deg,_#020617_0%,_#0b0f2e_50%,_#1a0e1f_100%)] py-32">
      ...
      <Container>
        <div className="rounded-[20px] border border-white/70 bg-white/70 dark:bg-slate-900/70 p-6 shadow-[0_20px_6px_-28px_rgba(15,23,42,0.2)] backdrop-blur sm:py-12 sm:px-8 lg:p-10">
          <TestimonialHeader />
          <div className="mt-16">
            <TestimonialSlider />
          </div>
