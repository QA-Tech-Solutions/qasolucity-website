...
export default function Services() {
  return (
    <Section className="relative overflow-hidden bg-[linear-gradient(135deg,_#faf8f4_0%,_#f7f3ff_48%,_#f8fafc_100%)] dark:bg-[linear-gradient(135deg,_#020617_0%,_#0b0f2e_50%,_#1a0e1f_100%)] py-40">
      ...
      <Container>
        <div className="rounded-[20px] border border-white/70 bg-white/70 dark:bg-slate-900/70 p-6 shadow-[0_20px_4px_-28px_rgba(15,23,42,0.24)] backdrop-blur sm:px-8 sm:py-12">
          <SectionHeader />
          <div className="mt-12">
            <ServiceGrid />
          </div>
