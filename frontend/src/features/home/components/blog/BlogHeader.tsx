  ...
  return (
    ...
    >
      <div className="max-w-3xl">
        ...
        <h2 className="mt-5 text-4xl font-bold leading-tight tracking-tight text-slate-900 dark:text-slate-100 md:text-5xl lg:text-6xl">
      ...
      >
        <Link href="/blogs">
          <Button
            variant="outline"
            className="group h-14 rounded-2xl border-2 border-indigo-200 dark:border-indigo-800/60 px-7 text-indigo-600 dark:text-indigo-400 hover:border-indigo-500 dark:hover:border-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-950/40 hover:text-indigo-700 dark:hover:text-indigo-300"
          >
            View All Articles
