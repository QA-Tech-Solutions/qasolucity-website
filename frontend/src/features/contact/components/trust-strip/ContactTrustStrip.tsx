    ...
    <Section className="py-20 bg-white dark:bg-slate-900">
      <Container>
        <motion.div
          ...
          className="relative overflow-hidden rounded-[32px] border border-slate-200/80 dark:border-slate-800/80 bg-white dark:bg-slate-900 p-8 shadow-lg shadow-slate-200/40 dark:shadow-black/30 md:p-10"
        >
          {/* Decorative glows */}
          ...
          <div className="relative grid gap-8 md:grid-cols-2 xl:grid-cols-4 xl:divide-x xl:divide-slate-200/70 dark:xl:divide-slate-800/70">
