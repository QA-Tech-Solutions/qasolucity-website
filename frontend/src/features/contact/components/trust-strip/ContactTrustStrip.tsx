    ...
    <Section className="py-20 bg-white">
      <Container>
        <motion.div
          ...
          className="relative overflow-hidden rounded-[32px] border border-slate-200/80 bg-white p-8 shadow-lg shadow-slate-200/40 md:p-10"
        >
          {/* Decorative glows */}
          <div className="absolute -right-20 -top-20 h-64 w-64 rounded-full bg-indigo-100/20 blur-3xl pointer-events-none" />
