  ...
  return (
    <Section className="relative overflow-hidden py-32">
      ...
      <motion.div
        ...
        className="absolute -left-24 top-20 h-[420px] w-[420px] rounded-full bg-indigo-500/20 blur-[150px]"
      />
      <motion.div
        animate={{
          x: [20, -20, 20],
        ...
        className="absolute -right-32 bottom-20 h-[500px] w-[500px] rounded-full bg-violet-500/20 blur-[180px]"
      />
