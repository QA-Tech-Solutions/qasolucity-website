...
export default function WhyContactUs() {
  return (
    <Section className="relative overflow-hidden bg-white dark:bg-slate-900 py-32">
      {/* Background */}
      <div className="absolute inset-0 -z-10 pointer-events-none">
        <motion.div
          ...
          className="absolute left-1/2 top-1/2 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-indigo-50/50 dark:bg-indigo-950/30 blur-3xl"
        />
        <div
