...
export default function ResourceDetailPage({ resource }: ResourceDetailPageProps) {
  ...
  return (
    <>
      <Section className="relative overflow-hidden bg-[linear-gradient(135deg,_#f8f7ff_0%,_#eef2ff_45%,_#fdf2f8_100%)] pt-36 pb-24">
        ...
        <Container>
          <Link href="/resources" className="inline-flex items-center gap-2 text-sm font-semibold text-indigo-700 transition-colors hover:text-indigo-900">
      ...
      <Section className="bg-white py-24">
        <Container>
          <div className="rounded-[32px] border border-slate-200/80 bg-slate-50/70 p-8">
            <h3 className="text-2xl font-semibold text-slate-900">What teams gain</h3>
